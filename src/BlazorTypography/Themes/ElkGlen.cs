...
{
    class ElkGlen : BaseTypographyOptions
    {
        ...
        public override List<GoogleFont> GoogleFonts { get; set; } = new List<GoogleFont>
        {
            ...
            { new GoogleFont{ Name = "PT Sans", Styles = new List<string>{ "400", "400i", "700" } } }
        };
        ...
        public override List<string> HeaderFontFamily { get; set; } = new List<string> { "Oswald", "sans-serif" };
